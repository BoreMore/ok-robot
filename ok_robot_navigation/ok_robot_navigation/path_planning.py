...
def main(cfg):
    ...
    while True:
        if cfg.debug:
            ...
            try:
                paths = planner.plan(
                    start_xy=(0.861361, 1.809727), end_xy=end_xy, remove_line_of_sight_points=True
                )
            except:
        ...
        p1 = Point([0.861361, 1.809727, -1.247702])
        p2 = Point([1.221261, 1.482495, -1.250190])
        p3 = Point([0.528984, 1.450890, -1.251287])
