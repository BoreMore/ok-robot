...
class MyOdometrySubscriber(Node):
    ...
    def get_waypoints(self):
        with open('/home/hornywombat/ament_ws/src/lsy_laptop_dev/lsy_laptop_dev/path_result_transformed.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
    ...
    def current_position_callback(self, msg):
        ...
        current_position = np.array([msg.pose.position.y / 1000.0, -msg.pose.position.x / 1000.0])
